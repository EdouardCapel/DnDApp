...
class SkillsTest < ApplicationSystemTestCase
  ...
  test "creating a Skill" do
    ...
    fill_in "Info", with: @skill.info
    check "Positif" if @skill.positif
    fill_in "Skillable", with: @skill.skillable_id
    fill_in "Skillable type", with: @skill.skillable_type
    fill_in "Title", with: @skill.title
    fill_in "Type", with: @skill.type
    fill_in "Type", with: @skill.type_id
    fill_in "Type value", with: @skill.type_value

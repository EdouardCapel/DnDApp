...
class CharactersTest < ApplicationSystemTestCase
  ...
  test "creating a Character" do
    ...
    fill_in "Info", with: @character.info
    fill_in "Levels", with: @character.levels_id
    fill_in "Life values", with: @character.life_values
    fill_in "Races", with: @character.races_id
